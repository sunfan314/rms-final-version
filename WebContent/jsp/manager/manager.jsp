...
<body class="easyui-layout">
	<div region="north" class="north" title="资产管理系统经理界面">
	...
	<div region="center" title="功能面板">
		<div class="easyui-tabs" fit="true" border="false" id="tabs">
			<div title="首页">
				<h1 style="font-size: 30px; margin: 40px;">欢迎来到资产管理系统经理界面</h1>
			</div>
		...
		var treeData = [ {
			...
			children : [ {
				...
				children : [ {
					text : "资产分配申请",
					attributes : {
						url : "${ctx}/manager/resourceAllocation.do"
					}
				}, {
					text : "资产购买申请",
					attributes : {
